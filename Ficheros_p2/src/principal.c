...
/* Forward declarations for TdS functions */
extern void cargaContexto(int n);
extern void descargaContexto(int n);
extern void mostrarTdS(void);
...
{ int i, n = 1;
  ...
  if (argc == n+1) {
    if ((yyin = fopen (argv[n], "r")) == NULL) {
      ...
      /* Inicializar la Tabla de Simbolos (TdS) antes del análisis */
      cargaContexto(0);
      yyparse ();
      /* Mostrar TdS si se solicita */
